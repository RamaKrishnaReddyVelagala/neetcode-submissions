class MinStack:
    ...
    def __init__(self):
        self.stack = []
        self.min_val = [float('inf'), float('inf')] # first shows first_min, second shows second min
    ...
    def push(self, val: int) -> None:
        ...
        if val < self.min_val[0]:
            ...
            self.min_val[0] = val
        elif val > self.min_val[0] and val < self.min_val[1]:
            self.min_val[1] = val
    ...
    def pop(self) -> None:
        ...
        if self.stack[-1] == self.min_val[1]:
            self.min_val[1] = float('inf')
        
        if self.stack[-1] == self.min_val[0]:
            self.min_val[0] = self.min_val[1]
            self.min_val[1] = float('inf')
